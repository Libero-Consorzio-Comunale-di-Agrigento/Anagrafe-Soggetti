CREATE TABLE TIPI_SOGGETTO_STORICO
(
...
COMMENT ON TABLE TIPI_SOGGETTO_STORICO IS 'TISS - TIPI RECAPITO STORICO';

COMMENT ON COLUMN TIPI_SOGGETTO_STORICO.OPERAZIONE IS 'I=Insert, D=Delete, BI=Before Image, AI=After Image';

COMMENT ON COLUMN TIPI_SOGGETTO_STORICO.BI_RIFERIMENTO IS 'id_evento di Before Image di riferimento';

CREATE OR REPLACE package anagrafe_soggetti_refresh is
/******************************************************************************
 NOME:        anagrafe_soggetti_tpk
 DESCRIZIONE: Gestione tabella ANAGRAFE_SOGGETTI.
 ANNOTAZIONI: Nel body inserite modifiche per refresh di eventuali SLAVE.
 REVISIONI:   Template Revision: 1.53.
 <CODE>
 Rev.  Data       Autore  Descrizione.
 00    17/09/2008  snegroni  Prima emissione.
...
, p_OLD_dal  in ANAGRAFE_SOGGETTI.dal%type default null
   , p_NEW_cognome  in ANAGRAFE_SOGGETTI.cognome%type default null
   , p_OLD_cognome  in ANAGRAFE_SOGGETTI.cognome%type default null
   , p_NEW_nome  in ANAGRAFE_SOGGETTI.nome%type default null
   , p_OLD_nome  in ANAGRAFE_SOGGETTI.nome%type default null
   , p_NEW_sesso  in ANAGRAFE_SOGGETTI.sesso%type default null
   , p_OLD_sesso  in ANAGRAFE_SOGGETTI.sesso%type default null
   , p_NEW_data_nas  in ANAGRAFE_SOGGETTI.data_nas%type default null
   , p_OLD_data_nas  in ANAGRAFE_SOGGETTI.data_nas%type default null
   , p_NEW_provincia_nas  in ANAGRAFE_SOGGETTI.provincia_nas%type default null
   , p_OLD_provincia_nas  in ANAGRAFE_SOGGETTI.provincia_nas%type default null
   , p_NEW_comune_nas  in ANAGRAFE_SOGGETTI.comune_nas%type default null
   , p_OLD_comune_nas  in ANAGRAFE_SOGGETTI.comune_nas%type default null
   , p_NEW_luogo_nas  in ANAGRAFE_SOGGETTI.luogo_nas%type default null
   , p_OLD_luogo_nas  in ANAGRAFE_SOGGETTI.luogo_nas%type default null
   , p_NEW_codice_fiscale  in ANAGRAFE_SOGGETTI.codice_fiscale%type default null
   , p_OLD_codice_fiscale  in ANAGRAFE_SOGGETTI.codice_fiscale%type default null
   , p_NEW_codice_fiscale_estero  in ANAGRAFE_SOGGETTI.codice_fiscale_estero%type default null
   , p_OLD_codice_fiscale_estero  in ANAGRAFE_SOGGETTI.codice_fiscale_estero%type default null
   , p_NEW_partita_iva  in ANAGRAFE_SOGGETTI.partita_iva%type default null
   , p_OLD_partita_iva  in ANAGRAFE_SOGGETTI.partita_iva%type default null
   , p_NEW_cittadinanza  in ANAGRAFE_SOGGETTI.cittadinanza%type default null
   , p_OLD_cittadinanza  in ANAGRAFE_SOGGETTI.cittadinanza%type default null
   , p_NEW_gruppo_ling  in ANAGRAFE_SOGGETTI.gruppo_ling%type default null
   , p_OLD_gruppo_ling  in ANAGRAFE_SOGGETTI.gruppo_ling%type default null
   , p_NEW_indirizzo_res  in ANAGRAFE_SOGGETTI.indirizzo_res%type default null
   , p_OLD_indirizzo_res  in ANAGRAFE_SOGGETTI.indirizzo_res%type default null
   , p_NEW_provincia_res  in ANAGRAFE_SOGGETTI.provincia_res%type default null
   , p_OLD_provincia_res  in ANAGRAFE_SOGGETTI.provincia_res%type default null
   , p_NEW_comune_res  in ANAGRAFE_SOGGETTI.comune_res%type default null
   , p_OLD_comune_res  in ANAGRAFE_SOGGETTI.comune_res%type default null
   , p_NEW_cap_res  in ANAGRAFE_SOGGETTI.cap_res%type default null
   , p_OLD_cap_res  in ANAGRAFE_SOGGETTI.cap_res%type default null
   , p_NEW_tel_res  in ANAGRAFE_SOGGETTI.tel_res%type default null
   , p_OLD_tel_res  in ANAGRAFE_SOGGETTI.tel_res%type default null
   , p_NEW_fax_res  in ANAGRAFE_SOGGETTI.fax_res%type default null
   , p_OLD_fax_res  in ANAGRAFE_SOGGETTI.fax_res%type default null
   , p_NEW_presso  in ANAGRAFE_SOGGETTI.presso%type default null
   , p_OLD_presso  in ANAGRAFE_SOGGETTI.presso%type default null
   , p_NEW_indirizzo_dom  in ANAGRAFE_SOGGETTI.indirizzo_dom%type default null
   , p_OLD_indirizzo_dom  in ANAGRAFE_SOGGETTI.indirizzo_dom%type default null
   , p_NEW_provincia_dom  in ANAGRAFE_SOGGETTI.provincia_dom%type default null
   , p_OLD_provincia_dom  in ANAGRAFE_SOGGETTI.provincia_dom%type default null
   , p_NEW_comune_dom  in ANAGRAFE_SOGGETTI.comune_dom%type default null
   , p_OLD_comune_dom  in ANAGRAFE_SOGGETTI.comune_dom%type default null
   , p_NEW_cap_dom  in ANAGRAFE_SOGGETTI.cap_dom%type default null
   , p_OLD_cap_dom  in ANAGRAFE_SOGGETTI.cap_dom%type default null
   , p_NEW_tel_dom  in ANAGRAFE_SOGGETTI.tel_dom%type default null
   , p_OLD_tel_dom  in ANAGRAFE_SOGGETTI.tel_dom%type default null
   , p_NEW_fax_dom  in ANAGRAFE_SOGGETTI.fax_dom%type default null
   , p_OLD_fax_dom  in ANAGRAFE_SOGGETTI.fax_dom%type default null
   , p_NEW_utente  in ANAGRAFE_SOGGETTI.utente%type default null
   , p_OLD_utente  in ANAGRAFE_SOGGETTI.utente%type default null
   , p_NEW_data_agg  in ANAGRAFE_SOGGETTI.data_agg%type default null
   , p_OLD_data_agg  in ANAGRAFE_SOGGETTI.data_agg%type default null
   , p_NEW_competenza  in ANAGRAFE_SOGGETTI.competenza%type default null
   , p_OLD_competenza  in ANAGRAFE_SOGGETTI.competenza%type default null
   , p_NEW_tipo_soggetto  in ANAGRAFE_SOGGETTI.tipo_soggetto%type default null
   , p_OLD_tipo_soggetto  in ANAGRAFE_SOGGETTI.tipo_soggetto%type default null
   , p_NEW_flag_trg  in ANAGRAFE_SOGGETTI.flag_trg%type default null
   , p_OLD_flag_trg  in ANAGRAFE_SOGGETTI.flag_trg%type default null
   , p_NEW_stato_cee  in ANAGRAFE_SOGGETTI.stato_cee%type default null
   , p_OLD_stato_cee  in ANAGRAFE_SOGGETTI.stato_cee%type default null
   , p_NEW_partita_iva_cee  in ANAGRAFE_SOGGETTI.partita_iva_cee%type default null
   , p_OLD_partita_iva_cee  in ANAGRAFE_SOGGETTI.partita_iva_cee%type default null
   , p_NEW_fine_validita  in ANAGRAFE_SOGGETTI.fine_validita%type default null
   , p_OLD_fine_validita  in ANAGRAFE_SOGGETTI.fine_validita%type default null
   , p_NEW_al  in ANAGRAFE_SOGGETTI.al%type default null
   , p_OLD_al  in ANAGRAFE_SOGGETTI.al%type default null
   , p_NEW_denominazione  in ANAGRAFE_SOGGETTI.denominazione%type default null
   , p_OLD_denominazione  in ANAGRAFE_SOGGETTI.denominazione%type default null
   , p_NEW_indirizzo_web  in ANAGRAFE_SOGGETTI.indirizzo_web%type default null
   , p_OLD_indirizzo_web  in ANAGRAFE_SOGGETTI.indirizzo_web%type default null
   , p_NEW_note  in ANAGRAFE_SOGGETTI.note%type default null
   , p_OLD_note  in ANAGRAFE_SOGGETTI.note%type default null
   , p_NEW_competenza_esclusiva  in ANAGRAFE_SOGGETTI.competenza_esclusiva%type default null

CREATE OR REPLACE TRIGGER TIPI_RECAPITO_STORICO_TIU
/******************************************************************************
                 NOME:        TIPI_RECAPITO_STORICO_TIU
                 DESCRIZIONE: Trigger for salvare dati storici
                                       at INSERT or UPDATE or DELETE on Table TIPI_RECAPITO
                 ECCEZIONI:
                 ANNOTAZIONI: -
                 REVISIONI:
...
DECLARE
    ...
    IS
        v_id_evento   NUMBER;
    BEGIN
        SELECT tirs_sq.NEXTVAL INTO v_id_evento FROM DUAL;
    ...
    BEGIN
        ...
        IF p_info = 'NEW'
        THEN
            INSERT INTO TIPI_RECAPITO_STORICO (ID_EVENTO,
                                               ID_TIPO_RECAPITO,
                                               DESCRIZIONE,
                                               UNICO,
                                               IMPORTANZA,
...
BEGIN
    ...
    ELSIF     UPDATING
          AND (   :new.ID_TIPO_RECAPITO != :old.ID_TIPO_RECAPITO
